    ...
    <section id="hero" className="relative pt-16 sm:pt-20 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl xl:max-w-7xl 2xl:max-w-8xl">
        <div className="text-center space-y-6 sm:space-y-8 lg:space-y-10 2xl:space-y-12">
          <InViewSlideIn direction="up" delay={0.2} duration={1.2}>
          ...
          <InViewFadeIn delay={0.6} duration={0.8}>
          ...
          <InViewFadeIn delay={0.8} duration={0.8}>
          ...
          {/* Supporting Points */}
          <InViewStaggerContainer staggerDelay={0.2} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mt-12 lg:mt-16 2xl:mt-20">
            <StaggerItem>
              <HoverScale scale={1.05} className="text-center space-y-2 sm:space-y-3 p-4 sm:p-6 lg:p-8 rounded-lg">
                <InViewFloating intensity={8} duration={3}>
                  <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl">⚡</div>
                </InViewFloating>
                <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-semibold text-lightning-yellow">AI Integration</h3>
                <p className="text-xs sm:text-sm lg:text-base text-gray-400 leading-tight">Document analysis, intelligent automation</p>
              </HoverScale>
            </StaggerItem>

            <StaggerItem>
              <HoverScale scale={1.05} className="text-center space-y-2 sm:space-y-3 p-4 sm:p-6 lg:p-8 rounded-lg">
                <InViewFloating intensity={8} duration={3.5}>
                  <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl">🤖</div>
                </InViewFloating>
                <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-semibold text-lightning-yellow">Smart Solutions</h3>
                <p className="text-xs sm:text-sm lg:text-base text-gray-400 leading-tight">AI agents that understand and respond intelligently</p>
              </HoverScale>
            </StaggerItem>

            <StaggerItem>
              <HoverScale scale={1.05} className="text-center space-y-2 sm:space-y-3 p-4 sm:p-6 lg:p-8 rounded-lg">
                <InViewFloating intensity={8} duration={4}>
                  <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl">🎯</div>
                </InViewFloating>
            ...
            <StaggerItem>
              <HoverScale scale={1.05} className="text-center space-y-2 sm:space-y-3 p-4 sm:p-6 lg:p-8 rounded-lg">
                <InViewFloating intensity={8} duration={4.5}>
                  <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl">🚀</div>
                </InViewFloating>
                <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-semibold text-lightning-yellow">Innovation Focus</h3>
                <p className="text-xs sm:text-sm lg:text-base text-gray-400 leading-tight">Pushing AI boundaries in practical applications</p>
              </HoverScale>
            </StaggerItem>
          </InViewStaggerContainer>

          {/* CTA Buttons */}
          <InViewFadeIn delay={1.2} duration={0.6}>
